(function(imgUrl){
    ...
    Object.assign(closeBtn.style,{
        ...
        borderRadius:'50%',border:'none',background:'#ffffff',color:'#222222',
        fontSize:'24px',cursor:'pointer',display:'flex',justifyContent:'center',
    ...
    Object.assign(img.style,{
        maxWidth:'90vw',maxHeight:'88vh',display:'block',objectFit:'contain'
    });

    function closePop(){ mask.remove(); }
    closeBtn.onclick = closePop;
    mask.onclick = function(e){ if(e.target === mask) closePop(); };

    box.appendChild(closeBtn);
    box.appendChild(img);
    mask.appendChild(box);
    document.body.appendChild(mask);
})("https://picsum.photos/id/237/1000/800");
